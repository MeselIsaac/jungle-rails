...
user2 = User.create!({
  ...
  last_name: "Spears",
  password_digest: "Mesel",
  email: "ItsBritneyBitch@Britney.com"
})
...
description: "Weird name for a product. Even weirder product", 
user_id: user2.id, 
rating: 3
})

prod2.ratings.create!({
description: "Not even real zebra!!!", 
user_id: user1.id, 
rating: 1
})

prod12.ratings.create!({
description: "Beacoup bucks too many.", 
user_id: user2.id, 
rating: 2
})
